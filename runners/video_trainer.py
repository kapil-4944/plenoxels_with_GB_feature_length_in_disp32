...
from plenoxels_with_GB_feature_length_in_disp32.ops.image.io import write_video_to_file
...
from .new_regularization import (
    PlaneTV, TimeSmoothness, HistogramLoss, L1TimePlanes, DistortionLoss,L1motionloss,L1TimePlanesRevgrid
)
...
class VideoTrainer(BaseTrainer):
    ...
    def get_regularizers(self, **kwargs):
        return [
            ...
            L1motionloss(kwargs.get('L1_motion_loss', 0), what='r_field')
        ]
