...
# from plenoxels_with_GB_feature_length_in_disp32.runners.new_regularization import L1motionloss
import numpy as np
import torch
...
from plenoxels_with_GB_feature_length_in_disp32.utils.ema import EMA
from plenoxels_with_GB_feature_length_in_disp32.models.lowrank_model import LowrankModel
from plenoxels_with_GB_feature_length_in_disp32.utils.my_tqdm import tqdm
from plenoxels_with_GB_feature_length_in_disp32.ops.image import metrics
from plenoxels_with_GB_feature_length_in_disp32.ops.image.io import write_png
from plenoxels_with_GB_feature_length_in_disp32.runners.regularization import Regularizer
from plenoxels_with_GB_feature_length_in_disp32.ops.lr_scheduling import (
...
class BaseTrainer(abc.ABC):
    def __init__(self,
        ...
        self.logger = SummaryWriter(log_dir=os.path.join(self.log_dir, "loss_info"))
    ...
    def _move_data_to_device(self, data):
        ...
        # data['video_num'] = data['video_num'].to(self.device)
