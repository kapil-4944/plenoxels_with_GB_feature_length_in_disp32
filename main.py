...
from plenoxels_with_GB_feature_length_in_disp32.tr_ts_data_loading  import tr_ts_load_data

from plenoxels_with_GB_feature_length_in_disp32.utils.create_rendering import render_to_path, decompose_space_time
...
def init_trainer(model_type: str, **kwargs):
    if model_type == "video":
        from plenoxels_with_GB_feature_length_in_disp32.runners import video_trainer
        return video_trainer.VideoTrainer(**kwargs)
    elif model_type == "phototourism":
        from plenoxels_with_GB_feature_length_in_disp32.runners import phototourism_trainer
        return phototourism_trainer.PhototourismTrainer(**kwargs)
    else:
        from plenoxels_with_GB_feature_length_in_disp32.runners import static_trainer
...
def main():
    ...
    # python plenoxels_with_GB_feature_length_in_disp32/main.py --config-path plenoxels_with_GB_feature_length_in_disp32/config/cfg.py max_ts_frames=200
